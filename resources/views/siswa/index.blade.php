        ...
        <div class="block-header">
            ...
            <div class="block-options">
                <button type="button" class="btn btn-sm btn-success mr-1 mb-3" data-toggle="modal"
                    data-target="#tambahDataSiswa">
                    <i class="fa fa-fw fa-plus mr-1"></i> Tambah Data Siswa
                </button>
            </div>
        </div>
...
<div class="modal fade" id="tambahDataSiswa" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
                ...
                <form action="/siswa/create" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group{{$errors->has('nis') ? 'has-error' : ''}}">
                        ...
                        <input type="text" name="nis" class="form-control" id="inputNis"
                            aria-describedby="NIS" placeholder="NIS" value="{{old('nis')}}">
                        @if($errors->has('nis'))
                    ...
                    <div class="form-group{{$errors->has('kelas') ? 'has-error' : ''}}">
                        <label for="inputKelas">Pilih Kelas</label>
                        <select name="kelas" class="form-control" id="inputKelas">
                            <option value="10" {{(old('jurusan') == '10') ? ' selected' : ''}}>10</option>
                            <option value="11" {{(old('jurusan') == '11') ? ' selected' : ''}}>11</option>
                            <option value="12" {{(old('jurusan') == '12') ? ' selected' : ''}}>12</option>
                        </select>
                        @if($errors->has('kelas'))
                    ...
                    <div class="form-group{{$errors->has('jenis_kelamin') ? 'has-error' : ''}}">
                        <label for="inputJenisKelamin">Pilih Jenis Kelamin</label>
                    ...
                    <div class="form-group{{$errors->has('jurusan') ? 'has-error' : ''}}">
                        <label for="inputJurusan">Pilih Jurusan</label>
