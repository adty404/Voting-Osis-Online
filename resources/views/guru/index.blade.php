        ...
        <div class="block-header">
            ...
            <div class="block-options">
                <button type="button" class="btn btn-sm btn-success mr-1 mb-3" data-toggle="modal"
                    data-target="#tambahDataGuru">
                    <i class="fa fa-fw fa-plus mr-1"></i> Tambah Data Guru
                </button>
            </div>
        </div>
...
<div class="modal fade" id="tambahDataGuru" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
