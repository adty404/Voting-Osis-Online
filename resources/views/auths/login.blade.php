    ...
    <body>
                ...
                <div class="hero-static d-flex align-items-center">
                    <div class="w-100">
                        ...
                        <div class="content content-full bg-white">
                            <div class="row justify-content-center">
                                <div class="col-md-8 col-lg-6 col-xl-4 py-4">
                                    ...
                                    <form class="js-validation-signin" action="/postlogin" method="POST">
                                        {{csrf_field()}}
                                        @if(session('error'))
                        ...
                        <div class="font-size-sm text-center text-muted py-3">
                            <strong>Aditya Prasetyo</strong> &copy; <span data-toggle="year-copy"></span>
                        </div>
                        <!-- END Footer -->
                    </div>
                </div>
        ...
        {{-- <script>
                @if(Session::has('error'))
                    toastr.success("{{Session::get('error')}}", "Gagal")
                @endif
        </script> --}}
    </body>
</html>