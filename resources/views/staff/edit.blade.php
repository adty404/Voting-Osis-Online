...
<div class="content">
    <div class="block">
        <div class="block-header">
            <h3 class="block-title">Edit Data Staff</h3>
        </div>
            ...
            <form action="/staff/{{$staff->id}}/update" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" id="pilihStatus" name="status">
                        <option value="Belum Voting" @if($staff -> status == 'Belum Voting') selected @endif>Belum Voting</option>
                        <option value="Sudah Voting" @if($staff -> status == 'Sudah Voting') selected @endif>Sudah Voting</option>
                    </select>
